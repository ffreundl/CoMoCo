...
class Reflexes(object):
    ...
    def stance_2_lift_off(self, side):
        ...
        K1 = 0.55 #  CF: Must be active for stance, it allows not to fall by activating CF
        K2 = 0.45 #  CF: Used in case the mouse stands too straight and to the back
        K3 = 0.05
        K4 = 0.2 # RF: Must be activated
        K5 = 0.7 # SOL: Must be activated
        K6 = 0.5 # LG: Must be activated
